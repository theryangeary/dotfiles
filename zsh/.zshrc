...
alias k="killall"
alias prs="gh search prs "archived:false" --author @me --owner lyft --state open --json repository,number,title,url,updatedAt --template '{{range .}}{{tablerow .title .url}}{{end}}{{tablerender}}'"
